declare global {
  const GqlGetAllTags: typeof import('#gql-nitro')['GqlGetAllTags']
  const GqlGetQueryPosts: typeof import('#gql-nitro')['GqlGetQueryPosts']
  const GqlGetRecentPosts: typeof import('#gql-nitro')['GqlGetRecentPosts']
...
export { GqlGetAllTags, GqlGetQueryPosts, GqlGetRecentPosts } from '#gql-nitro';
