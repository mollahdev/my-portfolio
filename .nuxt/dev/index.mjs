...
import { renderSSRHead } from 'file:///Volumes/www/my-portfolio/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Volumes/www/my-portfolio/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Volumes/www/my-portfolio/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Volumes/www/my-portfolio/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Volumes/www/my-portfolio/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Volumes/www/my-portfolio/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Volumes/www/my-portfolio/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Volumes/www/my-portfolio/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Volumes/www/my-portfolio/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Volumes/www/my-portfolio/node_modules/ufo/dist/index.mjs';
...
import { version, unref } from 'file:///Volumes/www/my-portfolio/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Volumes/www/my-portfolio/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Volumes/www/my-portfolio/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "alias": {},
    "fs": {
      "dir": "/Volumes/www/my-portfolio/public"
    },
    "http": {
      "domains": []
    }
...
const serverAssets = [{"baseName":"server","dir":"/Volumes/www/my-portfolio/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/www/my-portfolio","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Volumes/www/my-portfolio/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/www/my-portfolio/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Volumes/www/my-portfolio/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Volumes/www/my-portfolio/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _qi2qtEfhXS = (function(nitro) {
...
const _llMAuX = lazyEventHandler(() => {
...
const _lazy_1ARlNu = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_1ARlNu, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _llMAuX, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_1ARlNu, lazy: true, middleware: false, method: undefined }
];
