<template>
    <svg data-hk="s00-3-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 flex-none ">
        <title class="sr-only">EnvelopeOpen Icon</title>
